...
// Step 1: parse + mesh separation — call from IO thread
// Creates renderer if not yet initialized (safe: parseModel has no GL calls)
...
// Step 2: GPU upload — call from GL thread (fast, < 100ms)
